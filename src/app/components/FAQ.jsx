        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              processing is done locally on your machine, ensuring your footage
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              editing software including Final Cut Pro, Adobe Premiere Pro, and
              DaVinci Resolve. Your organized footage can be directly imported
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              ...
              Whether you're working with hours of interview footage or multiple
              camera angles, Clova can process and organize it all.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
